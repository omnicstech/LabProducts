...
<div class="specs_wrapper">
  <div class="specs_img_holder">
  	...
  	<!-- <div class="arrow_left" onclick="prevSpecImage('pro1');"><img src="https://s3.amazonaws.com/files.humotech.com/website/products/arrow_left.png" width="50" height="61" alt=""></div>
  	<div class="arrow_right" onclick="nextSpecImage('pro1');"><img src="https://s3.amazonaws.com/files.humotech.com/website/products/arrow_right.png" width="50" height="61" alt=""></div> -->
  </div>
  ...
  <table class="specs_table" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
  	...
  	<tr>
  	  ...
  	  <td width="30%" class="padded borderBottom borderRight">Plantarflexion</td>
  	  <td width="30%" class="padded borderBottom">41 degrees</td>
    </tr>
  	<tr>
  	  <td width="30%" class="padded borderBottom borderRight">Dorsiflexion</td>
